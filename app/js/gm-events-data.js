...
export const RANDOM_EVENTS = [
  [1,   1,   'The ground shakes violently and a massive fissure opens'],
  [2,   3,   'An unseen foe leaps out of hiding at close range'],
  [4,   5,   'A horrible buzzing fills the air, growing louder and louder'],
  [6,   7,   'You catch the acrid smell of smoke and flame'],
  [8,   9,   'A bright star appears in the sky, visible even at midday'],
  ...
  [100, 100, 'A radiant being appears to you with a message of warning'],
];
