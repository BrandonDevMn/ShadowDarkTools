 ...
 * Rumor table (d100).
 *
 * Each entry is [min, max, text]. Roll 1–100 (treating "00" as 100).
 */
export const RUMORS = [
  [1,   1,   'An armored beast the size of a ship is rampaging nearby'],
  [2,   3,   'A team of assassins is on its way to kill your group'],
  [4,   5,   'The local ruler has placed a 2,000 gp bounty on your heads'],
  [6,   7,   'The cult of Shune is planning a fiery coup at midnight'],
  [8,   9,   'An ancient, stone door has been found in the castle cellar'],
  ...
  [100, 100, 'The dragon Ixamir has awoken from her 200-year slumber'],
];
