...
Use these tables to randomly generate adventure hooks and site names.

For the adventure generator, use some or all of the details and names you roll. Modify the connecting words as needed.
